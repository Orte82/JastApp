...
import com.orte.pluralsight.javadatastructures.stack.BasicStack;
import com.orte.pluralsight.javadatastructures.stack.Stack;
...
public class CardStackApp {
    ...
    public void unstackCards() {
        ...
        BasicStack<String> bs =(BasicStack<String>) stack;
        while(bs.size() > 0) {
